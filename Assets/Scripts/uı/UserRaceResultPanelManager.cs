...
public class UserRaceResultPanelManager : MonoBehaviour
{
    [SerializeField] private List<Image> photoSlots; 
    [SerializeField] private TMP_Text _timeText; 
    [SerializeField] private TMP_Text _usernameText;
    
    private RaceResultRenderManager _raceResultRenderManager;
    ...
    public void Initialize(StartPopUpController startPopUpController, TimeController timeController, 
        RaceResultRenderManager raceResultRenderManager)
    {
        ...
        _raceResultRenderManager = raceResultRenderManager;
    }
    ...
    public void LoadPhotos()
    {
        ...
        _raceResultRenderManager.CaptureScreenshot(_startPopUpController.Username, elapsedTime);
